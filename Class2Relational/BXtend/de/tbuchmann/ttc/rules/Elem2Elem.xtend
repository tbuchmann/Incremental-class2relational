...
abstract class Elem2Elem {
	...
	val static sourcePackage = class_.Class_Package::eINSTANCE
	val static targetPackage = relational_.RelationalPackage::eINSTANCE
	val static sourceFactory = class_.Class_Factory::eINSTANCE
	val static targetFactory = relational_.RelationalFactory::eINSTANCE
