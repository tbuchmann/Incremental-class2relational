...
abstract class MultiAttribute2Table extends Elem2Elem {
	...
	def protected abstract Type4tblName tblNameFrom(String attName, class_.Class owner);
	
	@Data protected static class Type4col {
		List<relational_.Column> col
	}
	def protected abstract Type4col colFrom(String attName, class_.Classifier type, class_.Class owner);
