 ...
 * </ul>
 *
 * @see relational_.RelationalPackage#getColumn()
 * @model
 * @generated
 */
public interface Column extends Named {
	 ...
	 * @see #setOwner(Table)
	 * @see relational_.RelationalPackage#getColumn_Owner()
	 ...
	 * @see #setKeyOf(Table)
	 * @see relational_.RelationalPackage#getColumn_KeyOf()
	 ...
	 * @see #setType(Type)
	 * @see relational_.RelationalPackage#getColumn_Type()
